import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, isRef, resolveComponent, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, createVNode, resolveDynamicComponent, useSSRContext, useAttrs, mergeModels, useModel, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, watch, useSlots, Fragment, renderList, withModifiers, markRaw, useId, toHandlers, createSlots, Suspense, withAsyncContext, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs";
import { baseURL, publicAssetsURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/h3@1.15.4/node_modules/h3/dist/index.mjs";
import { withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash, parseURL, withLeadingSlash, withBase, withoutBase, encodeParam, encodePath } from "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs";
import { defu, defuFn } from "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs";
import { klona } from "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs";
import { stringify, parse } from "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/devalue@5.5.0/node_modules/devalue/index.js";
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1, resolveUnrefHeadInput } from "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3_/node_modules/@unhead/vue/dist/index.mjs";
...
import { useForwardProps, Primitive, Slot, useForwardPropsEmits, ProgressRoot, ProgressIndicator, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider, DialogRoot, DialogTrigger, DialogPortal, DialogOverlay, DialogContent, VisuallyHidden, DialogTitle, DialogDescription, DialogClose, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow, DropdownMenuRoot, DropdownMenuTrigger, DropdownMenuArrow, AccordionRoot, AccordionItem, AccordionTrigger, AccordionContent } from "reka-ui";
import { reactivePick, useDebounceFn, reactiveOmit, createSharedComposable, createReusableTemplate } from "@vueuse/core";
import { createTV } from "tailwind-variants";
import { getIconCSS } from "@iconify/utils/lib/css/icon";
import { debounce } from "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/perfect-debounce@2.0.0/node_modules/perfect-debounce/dist/index.mjs";
...
import { pascalCase } from "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs";
...
const unhead_iCNISNK2hn863eTcC_2m_6_kkXy7JRgQbW3oJgCZ5h4 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-qSmS_Nw7.js")
  },
  {
    name: "slug",
    path: "/:slug(.*)*",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/_...slug_-DFoi46Qr.js")
  }
];
...
const revive_payload_server_RdoiJxacf3GbKwPpUuu8uR0nOC2zxryPZe9gb09899E = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyProseADVue = defineAsyncComponent(() => import("./_nuxt/A.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/A-BoVi7ZML.js").then((r) => r["default"] || r.default || r));
const LazyProseAccordionDVue = defineAsyncComponent(() => import("./_nuxt/Accordion.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseAccordion = defineAsyncComponent(() => import("./_nuxt/Accordion-K_LO7yP1.js").then((r) => r["default"] || r.default || r));
const LazyProseAccordionItemDVue = defineAsyncComponent(() => import("./_nuxt/AccordionItem.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseAccordionItem = defineAsyncComponent(() => import("./_nuxt/AccordionItem-DKHnZOsV.js").then((r) => r["default"] || r.default || r));
const LazyProseBadgeDVue = defineAsyncComponent(() => import("./_nuxt/Badge.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseBadge = defineAsyncComponent(() => import("./_nuxt/Badge-BopN4Txe.js").then((r) => r["default"] || r.default || r));
const LazyProseBlockquoteDVue = defineAsyncComponent(() => import("./_nuxt/Blockquote.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import("./_nuxt/Blockquote-C3wMBAAk.js").then((r) => r["default"] || r.default || r));
const LazyProseCalloutDVue = defineAsyncComponent(() => import("./_nuxt/Callout.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseCallout = defineAsyncComponent(() => import("./_nuxt/Callout-BKnci_XI.js").then((r) => r["default"] || r.default || r));
const LazyProseCardDVue = defineAsyncComponent(() => import("./_nuxt/Card.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseCard = defineAsyncComponent(() => import("./_nuxt/Card-BOmD4N1y.js").then((r) => r["default"] || r.default || r));
const LazyProseCardGroupDVue = defineAsyncComponent(() => import("./_nuxt/CardGroup.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseCardGroup = defineAsyncComponent(() => import("./_nuxt/CardGroup-DcCCWGwb.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeDVue = defineAsyncComponent(() => import("./_nuxt/Code.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import("./_nuxt/Code-B47uQ2P_.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeCollapseDVue = defineAsyncComponent(() => import("./_nuxt/CodeCollapse.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeCollapse = defineAsyncComponent(() => import("./_nuxt/CodeCollapse-Cvxg6sRo.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeGroupDVue = defineAsyncComponent(() => import("./_nuxt/CodeGroup.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeGroup = defineAsyncComponent(() => import("./_nuxt/CodeGroup-COwUa9t3.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeIconDVue = defineAsyncComponent(() => import("./_nuxt/CodeIcon.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeIcon = defineAsyncComponent(() => import("./_nuxt/CodeIcon-Cx_7xPX_.js").then((r) => r["default"] || r.default || r));
const LazyProseCodePreviewDVue = defineAsyncComponent(() => import("./_nuxt/CodePreview.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseCodePreview = defineAsyncComponent(() => import("./_nuxt/CodePreview-C-CvIyKv.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeTreeDVue = defineAsyncComponent(() => import("./_nuxt/CodeTree.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeTree = defineAsyncComponent(() => import("./_nuxt/CodeTree-NAbLSv-8.js").then((r) => r["default"] || r.default || r));
const LazyProseCollapsibleDVue = defineAsyncComponent(() => import("./_nuxt/Collapsible.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseCollapsible = defineAsyncComponent(() => import("./_nuxt/Collapsible-CLByM14g.js").then((r) => r["default"] || r.default || r));
const LazyProseEmDVue = defineAsyncComponent(() => import("./_nuxt/Em.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import("./_nuxt/Em-J-k08lqf.js").then((r) => r["default"] || r.default || r));
const LazyProseFieldDVue = defineAsyncComponent(() => import("./_nuxt/Field.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseField = defineAsyncComponent(() => import("./_nuxt/Field-CC6q1eeq.js").then((r) => r["default"] || r.default || r));
const LazyProseFieldGroupDVue = defineAsyncComponent(() => import("./_nuxt/FieldGroup.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseFieldGroup = defineAsyncComponent(() => import("./_nuxt/FieldGroup-D1mR6GUR.js").then((r) => r["default"] || r.default || r));
const LazyProseH1DVue = defineAsyncComponent(() => import("./_nuxt/H1.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/H1-CF4K0kFI.js").then((r) => r["default"] || r.default || r));
const LazyProseH2DVue = defineAsyncComponent(() => import("./_nuxt/H2.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/H2-CiIda68n.js").then((r) => r["default"] || r.default || r));
const LazyProseH3DVue = defineAsyncComponent(() => import("./_nuxt/H3.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/H3-CQcKNorK.js").then((r) => r["default"] || r.default || r));
const LazyProseH4DVue = defineAsyncComponent(() => import("./_nuxt/H4.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/H4-HtGRPllj.js").then((r) => r["default"] || r.default || r));
const LazyProseHrDVue = defineAsyncComponent(() => import("./_nuxt/Hr.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/Hr-DtlGDzy2.js").then((r) => r["default"] || r.default || r));
const LazyProseIconDVue = defineAsyncComponent(() => import("./_nuxt/Icon.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseIcon = defineAsyncComponent(() => import("./_nuxt/Icon-DedqJYSW.js").then((r) => r["default"] || r.default || r));
const LazyProseImgDVue = defineAsyncComponent(() => import("./_nuxt/Img.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/Img-DfCZlTbX.js").then((r) => r["default"] || r.default || r));
const LazyProseKbdDVue = defineAsyncComponent(() => import("./_nuxt/Kbd.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseKbd = defineAsyncComponent(() => import("./_nuxt/Kbd-swCPekv1.js").then((r) => r["default"] || r.default || r));
const LazyProseLiDVue = defineAsyncComponent(() => import("./_nuxt/Li.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import("./_nuxt/Li-fHxjCBez.js").then((r) => r["default"] || r.default || r));
const LazyProseOlDVue = defineAsyncComponent(() => import("./_nuxt/Ol.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import("./_nuxt/Ol-CzMkDUeN.js").then((r) => r["default"] || r.default || r));
const LazyProsePDVue = defineAsyncComponent(() => import("./_nuxt/P.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import("./_nuxt/P-O9cxxrWc.js").then((r) => r["default"] || r.default || r));
const LazyProsePreDVue = defineAsyncComponent(() => import("./_nuxt/Pre.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import("./_nuxt/Pre-D9KO-V9m.js").then((r) => r["default"] || r.default || r));
const LazyProseScriptDVue = defineAsyncComponent(() => import("./_nuxt/Script.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import("./_nuxt/Script-DMDK92Nx.js").then((r) => r["default"] || r.default || r));
const LazyProseStepsDVue = defineAsyncComponent(() => import("./_nuxt/Steps.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseSteps = defineAsyncComponent(() => import("./_nuxt/Steps-CWoJgzlZ.js").then((r) => r["default"] || r.default || r));
const LazyProseStrongDVue = defineAsyncComponent(() => import("./_nuxt/Strong.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import("./_nuxt/Strong-Dt8j9xOw.js").then((r) => r["default"] || r.default || r));
const LazyProseTableDVue = defineAsyncComponent(() => import("./_nuxt/Table.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import("./_nuxt/Table-DwQdCvzV.js").then((r) => r["default"] || r.default || r));
const LazyProseTabsDVue = defineAsyncComponent(() => import("./_nuxt/Tabs.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseTabs = defineAsyncComponent(() => import("./_nuxt/Tabs-hTaBDmNx.js").then((r) => r["default"] || r.default || r));
const LazyProseTabsItemDVue = defineAsyncComponent(() => import("./_nuxt/TabsItem.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseTabsItem = defineAsyncComponent(() => import("./_nuxt/TabsItem-CgtZT9b8.js").then((r) => r["default"] || r.default || r));
const LazyProseTbodyDVue = defineAsyncComponent(() => import("./_nuxt/Tbody.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import("./_nuxt/Tbody-DGeMEWRG.js").then((r) => r["default"] || r.default || r));
const LazyProseTdDVue = defineAsyncComponent(() => import("./_nuxt/Td.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import("./_nuxt/Td-B_2UGpeK.js").then((r) => r["default"] || r.default || r));
const LazyProseThDVue = defineAsyncComponent(() => import("./_nuxt/Th.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import("./_nuxt/Th-rlwXopwP.js").then((r) => r["default"] || r.default || r));
const LazyProseTheadDVue = defineAsyncComponent(() => import("./_nuxt/Thead.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import("./_nuxt/Thead-DQ5IHy4d.js").then((r) => r["default"] || r.default || r));
const LazyProseTrDVue = defineAsyncComponent(() => import("./_nuxt/Tr.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import("./_nuxt/Tr-B0g3_HB7.js").then((r) => r["default"] || r.default || r));
const LazyProseUlDVue = defineAsyncComponent(() => import("./_nuxt/Ul.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import("./_nuxt/Ul-B3zCoT8w.js").then((r) => r["default"] || r.default || r));
const LazyProseCautionDVue = defineAsyncComponent(() => import("./_nuxt/Caution.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseCaution = defineAsyncComponent(() => import("./_nuxt/Caution-DQF_EpFA.js").then((r) => r["default"] || r.default || r));
const LazyProseNoteDVue = defineAsyncComponent(() => import("./_nuxt/Note.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseNote = defineAsyncComponent(() => import("./_nuxt/Note-DdPKMNjM.js").then((r) => r["default"] || r.default || r));
const LazyProseTipDVue = defineAsyncComponent(() => import("./_nuxt/Tip.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseTip = defineAsyncComponent(() => import("./_nuxt/Tip-0IoZZzfI.js").then((r) => r["default"] || r.default || r));
const LazyProseWarningDVue = defineAsyncComponent(() => import("./_nuxt/Warning.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseWarning = defineAsyncComponent(() => import("./_nuxt/Warning-B76TbTDN.js").then((r) => r["default"] || r.default || r));
const LazyProseH5DVue = defineAsyncComponent(() => import("./_nuxt/ProseH5.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5-CFvp9zdV.js").then((r) => r["default"] || r.default || r));
const LazyProseH6DVue = defineAsyncComponent(() => import("./_nuxt/ProseH6.d.vue-BTDBFo2Y.js").then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-CwZr8lMh.js").then((r) => r["default"] || r.default || r));
...
const componentNames = [{ "hash": "3WjFQtL4Ww14dJT-vzC-pgljVikKE-id0CV-AECyrxo", "pascalName": "OgImageDocs", "kebabName": "og-image-docs", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/app/components/OgImage/OgImageDocs.vue", "category": "app" }, { "hash": "lqi2TIJIQMafRl6atyAjEmgaOb13hjqfbfUGe7PXhOw", "pascalName": "BrandedLogoDVue", "kebabName": "branded-logo-d-vue", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.d.vue.ts", "category": "community", "credits": "Full Stack Heroes <https://fullstackheroes.com/>" }, { "hash": "SOHaoKfoo4fUkREsCFGw8ewxkl4-XkkHkug2VwYRtFM", "pascalName": "BrandedLogo", "kebabName": "branded-logo", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue", "category": "community" }, { "hash": "BMTMwASJKH3AG9ey0Y845iqbPNO7HjNX5eW2U2psVTE", "pascalName": "FrameDVue", "kebabName": "frame-d-vue", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.d.vue.ts", "category": "community", "credits": "@arashsheyda <https://github.com/arashsheyda>" }, { "hash": "tFoYPh0fXaZR3uXybAqFEOGnQuQsvz-E-Yq-CtrFlIY", "pascalName": "Frame", "kebabName": "frame", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue", "category": "community" }, { "hash": "XHXMYyA3oPy1eN81p4R-wv8k8tkHNooxhCRL8Zs1Pz0", "pascalName": "NuxtDVue", "kebabName": "nuxt-d-vue", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.d.vue.ts", "category": "community" }, { "hash": "NPQTTXYQ8toXx5OaJ1VlRUUcxy1SNOxg-FoM7C08ZPM", "pascalName": "Nuxt", "kebabName": "nuxt", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue", "category": "community" }, { "hash": "jGeID02J5-Tz9qaGIsRVZfJSXVQS9q-3V2Qnw65GQMg", "pascalName": "NuxtSeoDVue", "kebabName": "nuxt-seo-d-vue", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.d.vue.ts", "category": "community" }, { "hash": "VAHSTZlVcPHzkozocV1iTnwc4-YttdoOkHsYfoSgDZ4", "pascalName": "NuxtSeo", "kebabName": "nuxt-seo", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue", "category": "community" }, { "hash": "XHXMYyA3oPy1eN81p4R-wv8k8tkHNooxhCRL8Zs1Pz0", "pascalName": "PergelDVue", "kebabName": "pergel-d-vue", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.d.vue.ts", "category": "community" }, { "hash": "8CNn4yU043gQFqO-sZNDPz9GKED-h7ahXJ-61c9ThHM", "pascalName": "Pergel", "kebabName": "pergel", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue", "category": "community" }, { "hash": "7-N5uiZ77GftW16gAKUKdbC2kTqoiWjlYDsNWxCsCG4", "pascalName": "SimpleBlogDVue", "kebabName": "simple-blog-d-vue", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.d.vue.ts", "category": "community" }, { "hash": "b-Juo-FXQepo6SOCnA478MTAqbXNZuve6-MzHgTKA7s", "pascalName": "SimpleBlog", "kebabName": "simple-blog", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue", "category": "community" }, { "hash": "ahhiG3dVaeRX0C50qOnvcUsjBRro4ufe-6jzsUbVxBY", "pascalName": "UnJsDVue", "kebabName": "un-js-d-vue", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.d.vue.ts", "category": "community", "credits": "UnJS <https://unjs.io/>" }, { "hash": "vRUm5ru-64PEHIGsBby6-vCgLBg7iUJfvFKL6VuCXtI", "pascalName": "UnJs", "kebabName": "un-js", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue", "category": "community" }, { "hash": "pzp5dWaNkZa2Gbj-RXhoDiBahvrINMjPJC9-Vs2OtxE", "pascalName": "WaveDVue", "kebabName": "wave-d-vue", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.d.vue.ts", "category": "community", "credits": "Full Stack Heroes <https://fullstackheroes.com/>" }, { "hash": "hq07GBU-Yd16ICfETt8SfSxfaYj3qBmDAiQkTcv89nw", "pascalName": "Wave", "kebabName": "wave", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue", "category": "community" }, { "hash": "hsZbjduIx-cfHCcgbOY44VlwFWt5bfWv-VxiGiUifDs", "pascalName": "WithEmojiDVue", "kebabName": "with-emoji-d-vue", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.d.vue.ts", "category": "community", "credits": "Full Stack Heroes <https://fullstackheroes.com/>" }, { "hash": "zSwOodBXcjwS1qvFqGBJqitTEEnrvVfwQYkTeIxNpws", "pascalName": "WithEmoji", "kebabName": "with-emoji", "path": "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.24_typescript@5.9.3___h3@1.15.4_magicas_ebf520fb26b729213f3bd123e61ddf8a/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue", "category": "community" }];
...
const og_image_canonical_urls_server_MZnzZsEB_ByHy3giX0OlEORJZa0Q7C6IL53K2MAFk64 = /* @__PURE__ */ defineNuxtPlugin({
  setup(nuxtApp) {
    ogImageCanonicalUrls(nuxtApp);
  }
});
const route_rule_og_image_server_jL1y_4tlEivqAFsgriAZm__PnU3TmOUmhIkwpy1jBic = /* @__PURE__ */ defineNuxtPlugin({
  setup(nuxtApp) {
...
const colors_zC_87axTFjKaK69FS82DqpI5mkhQ1tFN6rePWLxwom0 = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugin_boaA6K4499L3aAJZm_frhPEfLiVhtMOGi2umrtAsNLo = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
let routes;
const prerender_server_1ELDaGBso0TKNYCPMChoIii94U2mgGXPAAaOmmnGrd0 = /* @__PURE__ */ defineNuxtPlugin(async () => {
  let __temp, __restore;
...
const plugins = [
  unhead_iCNISNK2hn863eTcC_2m_6_kkXy7JRgQbW3oJgCZ5h4,
  plugin,
  _0_siteConfig_o0ElaGTAhzE0zwX3jMcb0hE4qw8zfny61LYe1xx7jRA,
  revive_payload_server_RdoiJxacf3GbKwPpUuu8uR0nOC2zxryPZe9gb09899E,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  og_image_canonical_urls_server_MZnzZsEB_ByHy3giX0OlEORJZa0Q7C6IL53K2MAFk64,
  route_rule_og_image_server_jL1y_4tlEivqAFsgriAZm__PnU3TmOUmhIkwpy1jBic,
  colors_zC_87axTFjKaK69FS82DqpI5mkhQ1tFN6rePWLxwom0,
  plugin_server_1VsdcVlQN2tv6RG6Fy0EvkojZKbQX61TrTVJeEFBIfo,
  plugin_boaA6K4499L3aAJZm_frhPEfLiVhtMOGi2umrtAsNLo,
  prerender_server_1ELDaGBso0TKNYCPMChoIii94U2mgGXPAAaOmmnGrd0
];
...
_sfc_main$z.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Icon.vue");
...
const getImage = (src, { modifiers = {}, baseURL: baseURL2 } = {}, ctx) => {
  ...
  return {
    url: joinURL(baseURL2, params, encodePath(src).replace(/\/{2,}/g, "/"))
  };
};
const ipxStaticRuntime$frn9aQEoqCrTFaSzBluLX0v3KaSQpfZpGE_KKyWvOSw = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
const imageOptions = {
  ...
  providers: {
    ["ipxStatic"]: { provider: ipxStaticRuntime$frn9aQEoqCrTFaSzBluLX0v3KaSQpfZpGE_KKyWvOSw, defaults: {} }
  }
};
...
_sfc_main$y.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+image@1.11.0_db0@0.3.4_better-sqlite3@12.4.1__ioredis@5.8.2_magicast@0.5.1/node_modules/@nuxt/image/dist/runtime/components/NuxtImg.vue");
...
_sfc_main$x.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Chip.vue");
...
const _sfc_main$w = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(props.chip ? _sfc_main$x : unref(Primitive)), mergeProps({
        as: as.value.root
...
_sfc_main$w.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Avatar.vue");
...
_sfc_main$v.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/LinkBase.vue");
...
_sfc_main$u.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Link.vue");
...
_sfc_main$t.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Button.vue");
...
_sfc_main$s.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Progress.vue");
...
_sfc_main$r.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Toast.vue");
...
_sfc_main$q.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Toaster.vue");
...
_sfc_main$p.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/OverlayProvider.vue");
...
_sfc_main$o.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/App.vue");
...
_sfc_main$n.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Container.vue");
...
_sfc_main$m.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Slideover.vue");
...
_sfc_main$l.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Modal.vue");
...
_sfc_main$k.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Drawer.vue");
...
_sfc_main$j.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Header.vue");
...
_sfc_main$i.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Kbd.vue");
...
_sfc_main$h.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Tooltip.vue");
...
const _sfc_main$g = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$6), ...appConfig2.ui?.contentSearchButton || {} })());
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$t, mergeProps({
              ...
              !__props.collapsed ? {
                name: "trailing",
                fn: withCtx(({ ui: uiProxy }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
...
_sfc_main$g.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/content/ContentSearchButton.vue");
...
_sfc_main$f.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/color-mode/ColorModeImage.vue");
  return _sfc_setup$f ? _sfc_setup$f(props, ctx) : void 0;
};
const _imports_0 = publicAssetsURL("/logo_nfdi4chem_cs-CCSy-IxU.png");
...
const __nuxt_component_4$1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$1]]), { __name: "AppLogo" });
const _sfc_main$d = {
          ...
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, item.slot || "item", {
              ...
              if (unref(get)(item, props.labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"] || (unref(get)(item, props.descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : "item-description"])) {
                _push2(`<span class="${ssrRenderClass(__props.ui.itemWrapper({ class: [__props.uiOverride?.itemWrapper, item.ui?.itemWrapper] }))}"${_scopeId}><span class="${ssrRenderClass(__props.ui.itemLabel({ class: [__props.uiOverride?.itemLabel, item.ui?.itemLabel], active }))}"${_scopeId}>`);
                ...
                if (unref(get)(item, props.descriptionKey)) {
                  _push2(`<span class="${ssrRenderClass(__props.ui.itemDescription({ class: [__props.uiOverride?.itemDescription, item.ui?.itemDescription] }))}"${_scopeId}>`);
              ...
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                createVNode("span", {
                  ...
                  renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                    ...
                    item.children?.length ? (openBlock(), createBlock(_sfc_main$z, {
                      key: 0,
                      name: childrenIcon.value,
                      class: __props.ui.itemTrailingIcon({ class: [__props.uiOverride?.itemTrailingIcon, item.ui?.itemTrailingIcon], color: item?.color, active })
...
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/DropdownMenuContent.vue");
...
const _sfc_main$c = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const arrowProps = toRef(() => props.arrow);
    const getProxySlots = () => omit(slots, ["default"]);
    const ui = computed(() => tv({ extend: tv(theme$5), ...appConfig2.ui?.dropdownMenu || {} })({
      size: props.size
    }));
    return (_ctx, _push, _parent, _attrs) => {
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/DropdownMenu.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_UDropdownMenu, mergeProps({
    modal: false,
    items: [{
      label: "NFDI4Chem-Consortium",
      to: "https://www.nfdi4chem.de/"
    }, {
      label: "Web service",
      to: "https://webconverter.nfdi4chem.zih.tu-dresden.de/"
    }, {
      label: "Documentation",
      to: "https://nfdi4chem.github.io/cs-documentation/",
      color: "primary",
      checked: true,
      type: "checkbox"
    }, {
      ...
      label: "Contact",
      to: "https://webconverter.nfdi4chem.zih.tu-dresden.de/contact_info"
    }],
    content: { align: "start" },
...
const __nuxt_component_5$1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender]]), { __name: "TemplateMenu" });
const useColorMode = () => {
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/color-mode/ColorModeButton.vue");
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Badge.vue");
...
const _sfc_main$8 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const defaultValue = computed(() => {
      ...
      const indices = props.navigation?.reduce((acc, link, index2) => {
        if (isRouteInTree(link, route.path)) {
          acc.push(String(index2));
        }
        return acc;
      }, []) || [];
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        default: withCtx(({ link, active }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "link", {
              ...
              if (link.badge || link.children?.length && !disabled.value || link.trailingIcon || !!slots["link-trailing"]) {
                ...
                ssrRenderSlot(_ctx.$slots, "link-trailing", {
                  ...
                  if (link.children?.length && !disabled.value) {
                    _push2(ssrRenderComponent(_sfc_main$z, {
            ...
            return [
              renderSlot(_ctx.$slots, "link", {
                ...
                link.badge || link.children?.length && !disabled.value || link.trailingIcon || !!slots["link-trailing"] ? (openBlock(), createBlock("span", {
                  key: 1,
                  ...
                  renderSlot(_ctx.$slots, "link-trailing", {
                    ...
                    link.badge ? (openBlock(), createBlock(_sfc_main$9, mergeProps({
                      key: 0,
                      color: "neutral",
                      variant: "outline",
                      size: props.ui?.linkTrailingBadgeSize || ui.value.linkTrailingBadgeSize()
                    ...
                    link.children?.length && !disabled.value ? (openBlock(), createBlock(_sfc_main$z, {
                      key: 1,
                      name: link.trailingIcon || __props.trailingIcon || unref(appConfig2).ui.icons.chevronDown,
                      class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, link.ui?.linkTrailingIcon] })
                    }, null, 8, ["name", "class"])) : link.trailingIcon ? (openBlock(), createBlock(_sfc_main$z, {
                      key: 2,
                      name: link.trailingIcon,
                      class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, link.ui?.linkTrailingIcon] })
                    }, null, 8, ["name", "class"])) : createCommentVNode("", true)
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({ as: __props.as }, _ctx.$attrs, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(AccordionRoot), mergeProps({
              as: "ul",
              disabled: disabled.value
            }, unref(rootProps), {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(unref(AccordionTrigger), {
                              as: "button",
                              class: [
                                ui.value.link({ class: [props.ui?.link, link.ui?.link, link.class], active: link.active, disabled: !!link.disabled || disabled.value }),
                                ui.value.trigger({ class: [props.ui?.trigger, link.ui?.trigger], disabled: disabled.value })
                              ]
                            }, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  ...
                                  _push5(ssrRenderComponent(_sfc_main$8, mergeProps({ ref_for: true }, unref(rootProps), {
                                    ...
                                    renderList(slots, (_5, name) => {
                                      return {
                                        ...
                                        fn: withCtx((slotData, _push6, _parent6, _scopeId5) => {
                                          if (_push6) {
                                            ssrRenderSlot(_ctx.$slots, name, mergeProps({ ref_for: true }, { ...slotData, link }), null, _push6, _parent6, _scopeId5);
                                          } else {
                                            return [
                                              renderSlot(_ctx.$slots, name, mergeProps({ ref_for: true }, { ...slotData, link }))
                                            ];
                                          }
                                        })
                                      };
            ...
            return [
              createVNode(unref(AccordionRoot), mergeProps({
                ...
                _: 3
              }, 16, ["disabled", "default-value", "class"])
            ];
          }
        }),
        _: 3
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/content/ContentNavigation.vue");
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UContentSearchButton = _sfc_main$g;
      const _component_UColorModeImage = _sfc_main$f;
      const _component_NuxtLink = __nuxt_component_3$1;
      const _component_AppLogo = __nuxt_component_4$1;
      const _component_TemplateMenu = __nuxt_component_5$1;
      ...
      _push(ssrRenderComponent(_component_UHeader, mergeProps({
        ...
        right: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(header)?.links) {
              _push2(`<!--[-->`);
              ssrRenderList(unref(header).links, (link, index2) => {
                _push2(ssrRenderComponent(_component_UButton, mergeProps({ key: index2 }, { ref_for: true }, { color: "neutral", variant: "ghost", ...link }), null, _parent2, _scopeId));
              });
              _push2(`<!--]-->`);
            } else {
              _push2(`<!---->`);
            ...
            return [
              unref(header)?.search ? (openBlock(), createBlock(_component_UContentSearchButton, {
                key: 0,
                class: "lg:hidden"
              })) : createCommentVNode("", true),
              unref(header)?.colorMode ? (openBlock(), createBlock(_component_UColorModeButton, { key: 1 })) : createCommentVNode("", true),
              unref(header)?.links ? (openBlock(true), createBlock(Fragment, { key: 2 }, renderList(unref(header).links, (link, index2) => {
                return openBlock(), createBlock(_component_UButton, mergeProps({ key: index2 }, { ref_for: true }, { color: "neutral", variant: "ghost", ...link }), null, 16);
              }), 128)) : createCommentVNode("", true)
            ];
          }
        }),
        ...
        unref(header)?.logo?.dark || unref(header)?.logo?.light || unref(header)?.title ? {
          name: "title",
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(header)?.logo?.dark || unref(header)?.logo?.light) {
                _push2(ssrRenderComponent(_component_UColorModeImage, {
                  light: unref(header)?.logo?.light,
                  dark: unref(header)?.logo?.dark,
                  alt: unref(header)?.logo?.alt,
                  class: "h-6 w-auto shrink-0"
                }, null, _parent2, _scopeId));
              } else if (unref(header)?.title) {
                _push2(`<span${_scopeId}>${ssrInterpolate(unref(header).title)}</span>`);
              } else {
                _push2(`<!---->`);
              }
            } else {
              return [
                unref(header)?.logo?.dark || unref(header)?.logo?.light ? (openBlock(), createBlock(_component_UColorModeImage, {
                  key: 0,
                  light: unref(header)?.logo?.light,
                  dark: unref(header)?.logo?.dark,
                  alt: unref(header)?.logo?.alt,
                  class: "h-6 w-auto shrink-0"
                }, null, 8, ["light", "dark", "alt"])) : unref(header)?.title ? (openBlock(), createBlock("span", { key: 1 }, toDisplayString(unref(header).title), 1)) : createCommentVNode("", true)
              ];
            }
          }),
          key: "0"
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(ssrRenderComponent(_component_TemplateMenu, null, null, _parent2, _scopeId));
            } else {
              return [
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Main.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const layouts = {
  docs: defineAsyncComponent(() => import("./_nuxt/docs-ZPmFjdWn.js").then((m) => m.default || m))
};
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Footer.vue");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UFooter, _attrs, {
        left: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<b${_scopeId}>${ssrInterpolate(unref(footer).credits)}</b>`);
          } else {
            return [
              createVNode("b", null, toDisplayString(unref(footer).credits), 1)
            ];
          }
        }),
        right: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(footer)?.colorMode) {
              _push2(ssrRenderComponent(_component_UColorModeButton, null, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              unref(footer)?.colorMode ? (openBlock(), createBlock(_component_UColorModeButton, { key: 0 })) : createCommentVNode("", true),
              unref(footer)?.links ? (openBlock(true), createBlock(Fragment, { key: 1 }, renderList(unref(footer)?.links, (link, index2) => {
                return openBlock(), createBlock(_component_UButton, mergeProps({ key: index2 }, { ref_for: true }, { color: "neutral", variant: "ghost", ...link }), null, 16);
              }), 128)) : createCommentVNode("", true)
            ];
          }
...
const __nuxt_component_8_lazy = defineAsyncComponent(() => import("./_nuxt/ContentSearch-CVj8b5BD.js").then((c) => c.default || c));
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead({
      ...
      link: [
        { rel: "icon", href: "/favicon_nfdi4chem.ico" }
      ],
      htmlAttrs: {
        lang: "en"
      }
            ...
            return [
              ...
              !!__props.clear || !!slots.links ? (openBlock(), createBlock("div", {
                ...
                renderSlot(_ctx.$slots, "links", {}, () => [
                  __props.clear ? (openBlock(), createBlock(_sfc_main$t, mergeProps({
                    key: 0,
                    size: "lg",
                    color: "primary",
                    variant: "solid",
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/Error.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_5_lazy = defineAsyncComponent(() => import("./_nuxt/ContentSearch-CVj8b5BD.js").then((c) => c.default || c));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-DE6Ky_Wk.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.2.1_@parcel+watcher@2.5.1_@types+node@24.10.1_@vue+compiler-sfc@3.5.24_better-sq_d5dfd5fb52a0813023ffacdead0d9c6b/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export {
  ...
  setHeadOgImagePrebuilt as H,
  getOgImagePath as I,
  useRequestEvent as J,
  createOgImageMeta as K,
  queryCollectionItemSurroundings as L,
