import { useSlots, computed, ref, unref, mergeProps, withCtx, createVNode, renderSlot, createBlock, createCommentVNode, openBlock, useSSRContext, mergeModels, useModel, toRef, useTemplateRef, toDisplayString, createTextVNode, Fragment, renderList, createSlots, withKeys, toValue, isRef } from "vue";
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderList } from "vue/server-renderer";
import { Primitive, useForwardPropsEmits, useForwardProps, ListboxItem, ListboxItemIndicator, ListboxRoot, ListboxFilter, ListboxContent, ListboxVirtualizer, ListboxGroup, ListboxGroupLabel } from "reka-ui";
...
import { useVModel, reactivePick, createReusableTemplate, useDebounceFn, useActiveElement, useEventListener } from "@vueuse/core";
import { u as useAppConfig, a as useFormField, b as useFieldGroup, d as useComponentIcons, t as tv, _ as _sfc_main$3, e as _sfc_main$4, l as looseToNumber, f as useLocale, o as omit, g as _sfc_main$5, p as pickLinkProps, h as _sfc_main$6, j as _sfc_main$7, k as get, m as _sfc_main$8, n as _sfc_main$9, q as useKbd, r as useContentSearch, s as useColorMode, v as _sfc_main$a, w as transformUI } from "../server.mjs";
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(ListboxItem), {
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$5, mergeProps(unref(pickLinkProps)(item), { custom: "" }), {
                    default: withCtx(({ active, ...slotProps }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_sfc_main$6, mergeProps(slotProps, {
                            ...
                            if (_push5) {
                              ssrRenderSlot(_ctx.$slots, item.slot || group?.slot || "item", {
                                ...
                                if (item.prefix || (item.labelHtml || unref(get)(item, props.labelKey)) || (item.suffixHtml || item.suffix) || !!slots[item.slot ? `${item.slot}-label` : group?.slot ? `${group.slot}-label` : `item-label`] || (unref(get)(item, props.descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : group?.slot ? `${group.slot}-description` : `item-description`])) {
                                  _push5(`<span class="${ssrRenderClass(ui.value.itemWrapper({ class: [props.ui?.itemWrapper, item.ui?.itemWrapper] }))}"${_scopeId4}><span class="${ssrRenderClass(ui.value.itemLabel({ class: [props.ui?.itemLabel, item.ui?.itemLabel], active: active || item.active }))}"${_scopeId4}>`);
                                  ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-label` : group?.slot ? `${group.slot}-label` : `item-label`, {
                                    ...
                                    if (item.prefix) {
                                      _push5(`<span class="${ssrRenderClass(ui.value.itemLabelPrefix({ class: [props.ui?.itemLabelPrefix, item.ui?.itemLabelPrefix] }))}"${_scopeId4}>${ssrInterpolate(item.prefix)}</span>`);
                                    } else {
                                      _push5(`<!---->`);
                                    }
                                    _push5(`<span class="${ssrRenderClass(ui.value.itemLabelBase({ class: [props.ui?.itemLabelBase, item.ui?.itemLabelBase], active: active || item.active }))}"${_scopeId4}>${(item.labelHtml || unref(get)(item, props.labelKey)) ?? ""}</span><span class="${ssrRenderClass(ui.value.itemLabelSuffix({ class: [props.ui?.itemLabelSuffix, item.ui?.itemLabelSuffix], active: active || item.active }))}"${_scopeId4}>${(item.suffixHtml || item.suffix) ?? ""}</span>`);
                                  }, _push5, _parent5, _scopeId4);
                                  _push5(`</span>`);
                                  if (unref(get)(item, props.descriptionKey)) {
                                    _push5(`<span class="${ssrRenderClass(ui.value.itemDescription({ class: [props.ui?.itemDescription, item.ui?.itemDescription] }))}"${_scopeId4}>`);
                                ...
                                _push5(`<span class="${ssrRenderClass(ui.value.itemTrailing({ class: [props.ui?.itemTrailing, item.ui?.itemTrailing] }))}"${_scopeId4}>`);
                                ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : group?.slot ? `${group.slot}-trailing` : `item-trailing`, {
                                  ...
                                  if (item.children && item.children.length > 0) {
                                    ...
                                    _push5(`<span class="${ssrRenderClass(ui.value.itemTrailingKbds({ class: [props.ui?.itemTrailingKbds, item.ui?.itemTrailingKbds] }))}"${_scopeId4}><!--[-->`);
                              ...
                              return [
                                renderSlot(_ctx.$slots, item.slot || group?.slot || "item", {
                                  ...
                                  renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : group?.slot ? `${group.slot}-leading` : `item-leading`, {
                                    ...
                                    item.loading ? (openBlock(), createBlock(_sfc_main$3, {
                                      key: 0,
                                      name: __props.loadingIcon || unref(appConfig).ui.icons.loading,
                                      class: ui.value.itemLeadingIcon({ class: [props.ui?.itemLeadingIcon, item.ui?.itemLeadingIcon], loading: true })
                                    }, null, 8, ["name", "class"])) : item.icon ? (openBlock(), createBlock(_sfc_main$3, {
                                      key: 1,
                                      name: item.icon,
                                      class: ui.value.itemLeadingIcon({ class: [props.ui?.itemLeadingIcon, item.ui?.itemLeadingIcon], active: active || item.active })
                                      ...
                                      class: ui.value.itemLeadingAvatar({ class: [props.ui?.itemLeadingAvatar, item.ui?.itemLeadingAvatar], active: active || item.active })
                                    }), null, 16, ["size", "class"])) : item.chip ? (openBlock(), createBlock(_sfc_main$7, mergeProps({
                                      key: 3,
                                      size: item.ui?.itemLeadingChipSize || props.ui?.itemLeadingChipSize || ui.value.itemLeadingChipSize(),
                                      inset: "",
                                      standalone: ""
                                  ...
                                  createVNode("span", {
                                    ...
                                    renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : group?.slot ? `${group.slot}-trailing` : `item-trailing`, {
                                      ...
                                      item.children && item.children.length > 0 ? (openBlock(), createBlock(_sfc_main$3, {
                                        key: 0,
                                        name: __props.childrenIcon || unref(appConfig).ui.icons.chevronRight,
                                        class: ui.value.itemTrailingIcon({ class: [props.ui?.itemTrailingIcon, item.ui?.itemTrailingIcon] })
                                      ...
                                      ], 2)) : group?.highlightedIcon ? (openBlock(), createBlock(_sfc_main$3, {
                                        key: 2,
                                        name: group.highlightedIcon,
                                        class: ui.value.itemTrailingHighlightedIcon({ class: [props.ui?.itemTrailingHighlightedIcon, item.ui?.itemTrailingHighlightedIcon] })
                                      }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                  ...
                  return [
                    createVNode(_sfc_main$5, mergeProps(unref(pickLinkProps)(item), { custom: "" }), {
...
//# sourceMappingURL=ContentSearch-CVj8b5BD.js.map
