import { useSlots, computed, unref, mergeProps, withCtx, createVNode, createBlock, createCommentVNode, openBlock, renderSlot, createTextVNode, toDisplayString, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrInterpolate } from "vue/server-renderer";
import { Primitive } from "reka-ui";
import { u as useAppConfig, t as tv, V as getSlotChildrenText, _ as _sfc_main$1, g as _sfc_main$2 } from "../server.mjs";
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.to) {
              _push2(ssrRenderComponent(_sfc_main$2, mergeProps({ "aria-label": ariaLabel.value }, { to: __props.to, target: __props.target, ..._ctx.$attrs }, {
            ...
            return [
              ...
              createVNode("div", {
                ...
                __props.to ? (openBlock(), createBlock(_sfc_main$2, mergeProps({
                  key: 0,
...
//# sourceMappingURL=PageFeature-DiT9skX-.js.map
