import { _ as _sfc_main$e } from "./Page-Ii0Auzaf.js";
import { useSlots, computed, unref, mergeProps, withCtx, createBlock, createCommentVNode, createVNode, openBlock, renderSlot, createTextVNode, toDisplayString, Fragment, renderList, useSSRContext, defineComponent, ref, resolveComponent, watch, withModifiers, toValue, inject, withAsyncContext, createSlots } from "vue";
...
import { Primitive, useForwardProps, Separator, useForwardPropsEmits, CollapsibleRoot, CollapsibleTrigger, CollapsibleContent } from "reka-ui";
import { u as useAppConfig, t as tv, n as _sfc_main$8, A as useRoute, B as useToast, C as useSiteConfig, D as _sfc_main$9, _ as _sfc_main$a, e as _sfc_main$b, g as _sfc_main$c, f as useLocale, E as useRouter, F as useNuxtApp, p as pickLinkProps, h as _sfc_main$d, G as useOgImageRuntimeConfig, H as setHeadOgImagePrebuilt, I as getOgImagePath, J as useRequestEvent, K as createOgImageMeta, x as useAsyncData, y as queryCollection, c as createError, L as queryCollectionItemSurroundings, z as useSeoMeta } from "../server.mjs";
import { useClipboard, reactivePick, createReusableTemplate } from "@vueuse/core";
import { _ as __nuxt_component_5 } from "./ContentRenderer-CRCWOE1E.js";
...
import { appendHeader } from "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/h3@1.15.4/node_modules/h3/dist/index.mjs";
...
import "/home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs";
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$5), ...appConfig.ui?.pageHeader || {} })({
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    const props = __props;
    const appConfig = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$4), ...appConfig.ui?.pageBody || {} }));
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: __props.as,
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$3), ...appConfig.ui?.separator || {} })({
      color: props.color,
      ...
      _push(ssrRenderComponent(unref(DefineLinkTemplate), null, {
        default: withCtx(({ link, icon, direction }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              link ? (openBlock(), createBlock(_sfc_main$c, {
                key: 0,
                to: link.path,
                raw: "",
                class: ui.value.link({ class: [props.ui?.link, link.ui?.link, link.class], direction })
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(__props.links, (link, index) => {
              ...
              _push2(ssrRenderComponent(_sfc_main$c, mergeProps({ ref_for: true }, unref(pickLinkProps)(link), { custom: "" }), {
                default: withCtx(({ active, ...slotProps }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_sfc_main$d, mergeProps({ ref_for: true }, slotProps, {
              ...
              createVNode("ul", {
                ...
                (openBlock(true), createBlock(Fragment, null, renderList(__props.links, (link, index) => {
                  return openBlock(), createBlock("li", {
                    ...
                    createVNode(_sfc_main$c, mergeProps({ ref_for: true }, unref(pickLinkProps)(link), { custom: "" }), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      ...
                      unref(surround)?.length ? (openBlock(), createBlock(_component_USeparator, { key: 1 })) : createCommentVNode("", true),
                ...
                _push2(ssrRenderComponent(_component_UContentToc, {
                  ...
                  unref(toc)?.bottom ? {
                    ...
                    fn: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(`<div class="${ssrRenderClass([{ "!mt-6": unref(page).body?.toc?.links?.length }, "hidden lg:block space-y-6"])}"${_scopeId2}>`);
                        ...
                        return [
                          createVNode("div", {
                            class: ["hidden lg:block space-y-6", { "!mt-6": unref(page).body?.toc?.links?.length }]
                          }, [
...
//# sourceMappingURL=_...slug_-DFoi46Qr.js.map
