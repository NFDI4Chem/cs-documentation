...
import { u as useAppConfig, t as tv, P as _sfc_main$n, _ as _sfc_main$z, n as _sfc_main$t } from './server.mjs';
import _sfc_main$1 from './PageFeature-DiT9skX-.mjs';
                ...
                if (_push3) {
                  if (!!slots.header || (__props.icon || !!slots.leading) || (__props.headline || !!slots.headline) || (__props.title || !!slots.title) || (__props.description || !!slots.description) || !!slots.body || (((_a3 = __props.features) == null ? void 0 : _a3.length) || !!slots.features) || !!slots.footer || (((_b2 = __props.links) == null ? void 0 : _b2.length) || !!slots.links)) {
                    ...
                    if (!!slots.header || (__props.icon || !!slots.leading) || (__props.headline || !!slots.headline) || (__props.title || !!slots.title) || (__props.description || !!slots.description)) {
                      _push3(`<div class="${ssrRenderClass(ui.value.header({ class: (_d = props.ui) == null ? void 0 : _d.header }))}"${_scopeId2}>`);
                      ssrRenderSlot(_ctx.$slots, "header", {}, () => {
                        var _a4, _b3, _c2, _d2;
                        if (__props.icon || !!slots.leading) {
                          _push3(`<div class="${ssrRenderClass(ui.value.leading({ class: (_a4 = props.ui) == null ? void 0 : _a4.leading }))}"${_scopeId2}>`);
                        ...
                        if (__props.headline || !!slots.headline) {
                          _push3(`<div class="${ssrRenderClass(ui.value.headline({ class: (_b3 = props.ui) == null ? void 0 : _b3.headline, headline: !slots.headline }))}"${_scopeId2}>`);
                        ...
                        if (__props.title || !!slots.title) {
                          _push3(`<h2 class="${ssrRenderClass(ui.value.title({ class: (_c2 = props.ui) == null ? void 0 : _c2.title }))}"${_scopeId2}>`);
                        ...
                        if (__props.description || !!slots.description) {
                          _push3(`<div class="${ssrRenderClass(ui.value.description({ class: (_d2 = props.ui) == null ? void 0 : _d2.description }))}"${_scopeId2}>`);
                    ...
                    if (!!slots.body || (((_e = __props.features) == null ? void 0 : _e.length) || !!slots.features)) {
                      _push3(`<div class="${ssrRenderClass(ui.value.body({ class: (_f = props.ui) == null ? void 0 : _f.body }))}"${_scopeId2}>`);
                      ssrRenderSlot(_ctx.$slots, "body", {}, () => {
                        var _a4, _b3;
                        if (((_a4 = __props.features) == null ? void 0 : _a4.length) || !!slots.features) {
                          _push3(`<ul class="${ssrRenderClass(ui.value.features({ class: (_b3 = props.ui) == null ? void 0 : _b3.features }))}"${_scopeId2}>`);
                    ...
                    if (!!slots.footer || (((_g = __props.links) == null ? void 0 : _g.length) || !!slots.links)) {
                      _push3(`<div class="${ssrRenderClass(ui.value.footer({ class: (_h = props.ui) == null ? void 0 : _h.footer }))}"${_scopeId2}>`);
...
//# sourceMappingURL=PageSection-B2bNxrUV.mjs.map
