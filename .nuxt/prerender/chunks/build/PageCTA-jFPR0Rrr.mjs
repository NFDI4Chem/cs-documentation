...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a;
      return tv({ extend: tv(theme), ...((_a = appConfig.ui) == null ? void 0 : _a.pageCTA) || {} })({
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$n, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  if (!!slots.header || (__props.title || !!slots.title) || (__props.description || !!slots.description) || !!slots.body || !!slots.footer || (((_a3 = __props.links) == null ? void 0 : _a3.length) || !!slots.links)) {
                    ...
                    if (!!slots.header || (__props.title || !!slots.title) || (__props.description || !!slots.description)) {
                      ...
                      ssrRenderSlot(_ctx.$slots, "header", {}, () => {
                        ...
                        if (__props.title || !!slots.title) {
                          _push3(`<h2 class="${ssrRenderClass(ui.value.title({ class: (_a4 = props.ui) == null ? void 0 : _a4.title }))}"${_scopeId2}>`);
                        ...
                        if (__props.description || !!slots.description) {
                          _push3(`<div class="${ssrRenderClass(ui.value.description({ class: (_b3 = props.ui) == null ? void 0 : _b3.description }))}"${_scopeId2}>`);
                  ...
                  return [
                    !!slots.header || (__props.title || !!slots.title) || (__props.description || !!slots.description) || !!slots.body || !!slots.footer || (((_g = __props.links) == null ? void 0 : _g.length) || !!slots.links) ? (openBlock(), createBlock("div", {
                      key: 0,
            ...
            return [
              ...
              createVNode(_sfc_main$n, {
                ...
                default: withCtx(() => {
                  ...
                  return [
                    !!slots.header || (__props.title || !!slots.title) || (__props.description || !!slots.description) || !!slots.body || !!slots.footer || (((_a3 = __props.links) == null ? void 0 : _a3.length) || !!slots.links) ? (openBlock(), createBlock("div", {
                      key: 0,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.1.0_@babel+parser@7.28.5_change-case@5.4.4_db0@0.3.4_better-sqlite3@12.4.1___2c2c6ef4a5b84daf52befb879a0cfc05/node_modules/@nuxt/ui/dist/runtime/components/PageCTA.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=PageCTA-jFPR0Rrr.mjs.map
