import { P as _sfc_main$n, Q as _sfc_main$8, u as useAppConfig, t as tv } from './server.mjs';
import { _ as _sfc_main$2 } from './Page-Ii0Auzaf.mjs';
import { defineComponent, inject, withCtx, renderSlot, unref, createVNode, useSlots, computed, mergeProps, createBlock, createCommentVNode, openBlock, useSSRContext } from 'file:///home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/vue@3.5.24_typescript@5.9.3/node_modules/vue/index.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a;
      return tv({ extend: tv(theme), ...((_a = appConfig.ui) == null ? void 0 : _a.pageAside) || {} })();
    });
...
//# sourceMappingURL=docs-ZPmFjdWn.mjs.map
