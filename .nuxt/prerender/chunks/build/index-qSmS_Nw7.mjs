...
import { defineComponent, withAsyncContext, unref, mergeProps, useSSRContext } from 'file:///home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/cs-ms-documentation/cs-documentation/node_modules/.pnpm/vue@3.5.24_typescript@5.9.3/node_modules/vue/index.mjs';
...
import { x as useAsyncData, y as queryCollection, c as createError, z as useSeoMeta } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: page } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("index", () => queryCollection("landing").path("/").first())), __temp = await __temp, __restore(), __temp);
    if (!page.value) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(page)) {
        _push(ssrRenderComponent(_component_ContentRenderer, mergeProps({
          value: unref(page),
          prose: false
        }, _attrs), null, _parent));
      } else {
...
//# sourceMappingURL=index-qSmS_Nw7.mjs.map
