...
import { ssrRenderAttrs, ssrRenderStyle, ssrInterpolate } from 'file:///home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/nuxt-app/node_modules/.pnpm/vue@3.5.22_typescript@5.9.3/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full h-full flex flex-col bg-white" }, _attrs))}><div class="pt-[60px] pb-[70px] px-[6.75rem] h-full flex flex-col justify-between"><div class="flex flex-row justify-between"><div class="max-w-[700px]"><h1 class="mb-[30px] max-w-[700px] text-[60px] text-gray-900 font-normal flex flex-row"><p style="${ssrRenderStyle({ "display": "block", "overflow": "hidden", "line-clamp": "1", "text-overflow": "clip" })}">${ssrInterpolate(org.value)}</p>`);
      if (repo.value) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.22_typescript@5.9.3___h3@1.15.4_magicas_0874022927ed29d89bb1c0267b39548d/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=UnJs-D6Js84tx.mjs.map
