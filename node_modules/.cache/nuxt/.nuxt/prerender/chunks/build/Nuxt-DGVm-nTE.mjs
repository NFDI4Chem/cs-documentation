...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderStyle } from 'file:///home/lincoln/Desktop/NFDI4Chem/nfdi4chem_nuxt_cs_documentation/nuxt-app/node_modules/.pnpm/vue@3.5.22_typescript@5.9.3/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (title.value) {
        _push(`<h1 class="w-[600px] m-0 text-[75px] font-semibold mb-4 text-white" style="${ssrRenderStyle({ "display": "block", "line-clamp": "2", "text-overflow": "ellipsis" })}">${ssrInterpolate(title.value)}</h1>`);
      } else {
        _push(`<!---->`);
      }
      if (description.value) {
        _push(`<p class="text-[32px] text-[#E4E4E7] leading-tight" style="${ssrRenderStyle({ "display": "block", "line-clamp": "3", "text-overflow": "ellipsis" })}">${ssrInterpolate(description.value)}</p>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt-og-image@5.1.12_@unhead+vue@2.0.19_vue@3.5.22_typescript@5.9.3___h3@1.15.4_magicas_0874022927ed29d89bb1c0267b39548d/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=Nuxt-DGVm-nTE.mjs.map
